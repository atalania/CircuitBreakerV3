...
const STEM_BRIDGE_STUB = path.resolve(__dirname, "js/vendor/stem-assistant-bridge.js");
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: {
      alias: {
        // Standalone clones: shim matches portal guide API. Portal install uses file:../../packages/stem-assistant-bridge instead.
        "stem-assistant-bridge": STEM_BRIDGE_STUB,
      },
    },
